...
def call_Switch_3(event):
	if Switch_3 == 0:
		tcpClicSock.send(('Switch_4_on').encode())
	else:
		tcpClicSock.send(('Switch_4_off').encode())
...
def connection_thread():
	...
	while 1:
		...
		###
		elif 'Switch_4_on' in car_info:
			Switch_4 = 1
			Btn_Switch_4.config(bg='#4CAF50')	
		###
		...
		###
		elif 'Switch_4_off' in car_info:
			Switch_4 = 0
			Btn_Switch_4.config(bg=color_btn)	
		###
...
def loop():					  #GUI
	...
	while True:
		...
		###
		Btn_Switch_4 = tk.Button(root, width=8, text='Drehen',fg=color_text,bg=color_btn,relief='ridge')
		###
		Btn_Switch_1.place(x=30,y=265)
		Btn_Switch_2.place(x=100,y=265)
		Btn_Switch_3.place(x=170,y=265)
		###
		Btn_Switch_4.place(x=310,y=265)
		###
		...
		###
		Btn_Switch_3.bind('<ButtonPress-1>', call_Switch_4)
		###
