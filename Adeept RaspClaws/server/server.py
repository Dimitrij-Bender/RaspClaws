    ...
    while 1:
        if not steadyMode:
            if direction_command == 'forward' and turn_command == 'no':
                if SmoothMode:
                    move.dove(step_set,25,0.001,DPI,'no')
                    step_set += 1
                    if step_set == 5:
                        step_set = 1
                    continue
                else:
                    move.move(step_set, 25, 'no')
                    time.sleep(0.1)
                    step_set += 1
                    if step_set == 5:
                        step_set = 1
                ...
                if SmoothMode:
                    ...
                    if step_set == 5:
                        step_set = 1
                    continue
            elif direction_command == 'drehen_left':
                if SmoothMode:
                    move.dove_drehen(step_set,25,0.001,DPI,'left')
                    step_set += 1
                    if step_set == 5:
                        step_set = 1
                    continue
                else:
                    move.move_drehen(step_set, 25, 'left')
                    time.sleep(0.1)
                    step_set += 1
                    if step_set == 5:
                        step_set = 1
                    continue
            elif direction_command == 'drehen_right':
                if SmoothMode:
                    move.dove_drehen(step_set,25,0.001,DPI,'right')
                    step_set += 1
                    if step_set == 5:
                        step_set = 1
                    continue
                else:
                    move.move_drehen(step_set, 25, 'right')
                    time.sleep(0.1)
                    step_set += 1
                    if step_set == 5:
                        step_set = 1
            ...
            if turn_command != 'no':
                if SmoothMode:
                    move.dove(step_set,25,0.001,DPI,turn_command)
                    step_set += 1
                    if step_set == 5:
                        step_set = 1
                    continue
                else:
                    move.move(step_set, 25, turn_command)
                    time.sleep(0.1)
                    step_set += 1
                    if step_set == 5:
                        step_set = 1
...
def run():
    ...
    while True: 
        ...
        elif data == 'drehen_left':
            direction_command = 'drehen_left'  
        elif data == 'drehen_right':
            direction_command = 'drehen_right' 
        elif data == 'Stop':
